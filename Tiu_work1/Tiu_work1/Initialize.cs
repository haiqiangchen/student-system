...
namespace Tiu_work1
{
    class Initialize
    {
        ...
        public Initialize()
        {
            ...
            logsDb.This_days.Add(new This_day { Log = "今天天气好", Date_time = DateTime.Now.AddDays(-4).ToShortDateString() });
            logsDb.This_days.Add(new This_day { Log = "今天天气好", Date_time = DateTime.Now.AddDays(-6).ToShortDateString() });
            logsDb.This_days.Add(new This_day { Log = "今天天气好", Date_time = DateTime.Now.AddDays(-7).ToShortDateString() });
